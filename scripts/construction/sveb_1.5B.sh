...
python src/data_preparation/merge_for_training.py \
    ...
    --output_folder   data/1.5B/sveb_number/ \
    --exclude_test

#sveb_math
python src/data_preparation/merge_for_training.py \
    --input_files   src/data_preparation/openr1-220K/1.5B/sampled/0717/train.json \
    ...
    --num_samples   1000 1000 1000 \
    --output_folder   data/1.5B/sveb_math/ \
    --exclude_test
...
python src/data_preparation/merge_for_training.py \
    ...
    --num_samples   1000 1000 1000 \
    --output_folder data/1.5B/sveb_science/ \
    --exclude_test
...
python src/data_preparation/merge_for_training.py \
    ...
    --num_samples   1000 1000 1000 \
    --output_folder data/1.5B/sveb_general/ \
    --exclude_test
...
python src/data_preparation/merge_for_training.py \
    ...
    --num_samples   250 250 250 250 \
    --output_folder data/1.5B/sveb_program/ \
    --exclude_test