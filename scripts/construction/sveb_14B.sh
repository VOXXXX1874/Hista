...
python src/data_preparation/merge_training.py \
    ...
    --output_path   data/14B/SVEB-NUMBER/ \
    --exclude_test
...
python src/data_preparation/merge_training.py \
    ...
    --num_samples   500 500 500 500 500 500 \
    --output_path   data/14B/SVEB-MATH/ \
    --exclude_test
...
python src/data_preparation/merge_training.py \
    ...
    --output_folder data/14B/SVEB-SCIENCE/ \
    --exclude_test
...
python src/data_preparation/merge_training.py \
    ...
    --num_samples   1000 1000 1000 \
    --output_folder data/14B/SVEB-GENERAL/ \
    --exclude_test
...
python src/data_preparation/merge_training.py \
    ...
    --output_folder data/14B/SVEB-PROGRAMMING/ \
    --exclude_test