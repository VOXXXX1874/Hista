...
--num_processes=1 \
src/rl/grpo.py \
--config recipes/80G/Qwen2.5-1.5B/math/GRPO_base_dapo.yaml \
...
--num_processes=1 \
src/rl/hista.py \
--config recipes/80G/Qwen2.5-1.5B/math/Hista_base_dapo.yaml \
...
--num_processes=1 \
src/rl/grpo.py \
--config recipes/80G/Qwen2.5-1.5B/math/GRPO_base_csipo.yaml \
...
--num_processes=1 \
src/rl/hista.py \
--config recipes/80G/Qwen2.5-1.5B/math/Hista_base_csipo.yaml \
