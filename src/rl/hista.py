...
from rl.configs.hista_configs import HistaConfig
...
from rl.trainer.hista_trainer import HistaTrainer
...
if __name__ == "__main__":
    parser = TrlParser((GRPOPlusScriptArguments, HistaConfig, ModelConfig))
